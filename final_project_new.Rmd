...
Our goal was to look at data trends based on role and academic status (being freshman, sophmores, juniors, and seniors). For simplicity we categorize all guard variations as guards, and all the Powerforwards, centers and stretch as post players.
...
Sports require! Then how to evaluate a good team player, we measure player’s contributions and their impact on the court by BPM (Box Plus/Minus). The more time they contribute on the court, the more points they get. 
